...
<body>
    <div class="receipt-card">
        ...
        <div class="content">
            ...
            <div class="order-id-box">ID: #FNB-{{ str_pad($order->id, 5, '0', STR_PAD_LEFT) }}</div>
            ...
            <div class="item-row cf">
                ...
                <span class="item-name">{{ $item->foodBeverage->name }}</span>
                <span class="item-price-detail">{{ $item->quantity }} x {{ number_format($item->price, 0, ',', '.') }}</span>
            </div>
            @endforeach
            ...
            <div class="qr-section">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ $order->id }}" width="100">
                <div class="qr-footer">
