            ...
            @if($order->status == 'pending')
                ...
                <form action="{{ route('cart.pay_proses', $order->id) }}" method="POST" id="payment-form">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ route('cart.index') }}" class="w-full text-center bg-gray-200 hover:bg-gray-300 text-gray-600 font-bold py-3 rounded-xl transition duration-200 uppercase text-xs tracking-widest">
            ...
            @elseif($order->status == 'paid')
                <div class="h-full flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <div class="w-full space-y-3">
                        <a href="{{ route('food.history') }}" class="block w-full bg-gray-900 text-white font-bold py-4 rounded-xl hover:bg-black transition shadow-lg flex items-center justify-center gap-2 uppercase text-sm tracking-widest">
                             Lihat Riwayat Pesanan
                        </a>
                        <a href="{{ route('fnb.index') }}" class="block text-blue-600 font-bold text-xs hover:underline uppercase">Beli Snack Lagi</a>
                    </div>
                </div>
            @endif
        </div>
