...
<head>
    ...
    <style>
        ...
        .poster-bg {
            ...
            background-image: url("{{ $booking->showtime->movie->poster_url }}");
...
<body>
    ...
    <div class="content">
        ...
        <div class="genre">{{ $booking->showtime->movie->genre }} | {{ $booking->showtime->movie->age_rating }}</div>

        <div class="info-box">
            <div class="row">
                <div class="col">
                    <span class="label">STUDIO</span>
                    <span class="value">{{ $booking->showtime->auditorium->name }}</span>
                </div>
                <div class="col text-right">
                    <span class="label">TANGGAL</span>
                    <span class="value">{{ $booking->showtime->starts_at->format('d M Y') }}</span>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <span class="value">{{ $booking->showtime->starts_at->format('H:i') }} WIB</span>
                </div>
                <div class="col text-right">
            ...
            <div class="qr-section">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ $booking->booking_code }}" class="qr-img">
                <br><br>
