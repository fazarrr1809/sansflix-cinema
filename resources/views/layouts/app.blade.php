    ...
    <nav class="bg-gray-800 border-b border-gray-700 p-4 sticky top-0 z-50 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('profile.index') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-300 hover:bg-red-600 hover:text-white transition">
                ...
                @else
                    <a href="{{ route('login') }}" class="bg-red-600 text-white px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-red-700 transition">Login</a>
