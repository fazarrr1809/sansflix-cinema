                ...
                @auth
                    <div class="flex items-center gap-6">
                        <div class="relative inline-block group">
                            ...
                            <div class="absolute right-0 w-56 pt-2 bg-transparent opacity-0 translate-y-2 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible transition-all duration-200 z-[999]">
                                <div class="bg-gray-800 border border-gray-700 rounded-xl shadow-2xl overflow-hidden">
                                    <a href="{{ route('booking.history') }}" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:bg-red-600 hover:text-white transition border-b border-gray-700/50">
                                        <i class="fas fa-ticket-alt w-5 text-red-500 group-hover:text-white"></i> 
                                        <span>Tiket Saya</span>
                                    </a>
                                    <a href="{{ route('food.history') }}" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:bg-yellow-600 hover:text-white transition">
                        ...
                        <div class="flex items-center gap-4">
                            @auth
                                {{-- Link Profile berupa Avatar --}}
                                <a href="{{ route('profile.index') }}" class="group relative inline-block">
                                    ...
                                    {{-- Tooltip Nama (Opsional: Muncul saat dihover) --}}
                                ...
                                {{-- Tombol Logout (Biasanya diletakkan di samping atau dalam dropdown) --}}
                            ...
                            @else
                                <a href="{{ route('login') }}" class="text-white font-bold text-sm uppercase">Login</a>
                            @endauth
                        </div>
                    </div>
                @else
                    <a href="{{ route('login') }}" class="text-gray-300 hover:text-white font-medium mr-2">Masuk</a>
                    <a href="{{ route('register') }}" class="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-lg transition text-sm font-bold shadow-lg shadow-red-600/30 text-center">
                        Daftar
                    </a>
                @endauth
            </div>
