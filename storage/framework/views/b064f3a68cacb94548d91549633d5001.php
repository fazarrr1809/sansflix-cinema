...
<?php $__env->startSection('title', 'Struk Pesanan #' . $order->id); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-gray-950 min-h-screen py-12 flex flex-col items-center">
    <div class="w-full max-w-md mb-6">
        <a href="<?php echo e(route('food.history')); ?>" class="text-gray-500 hover:text-white transition flex items-center gap-2 text-sm">
        ...
        <div class="p-8 pt-12">
            <div class="text-center border-b-2 border-dashed border-gray-200 pb-6 mb-6">
                ...
                <div class="mt-4 bg-gray-100 py-2 rounded-lg font-mono text-sm font-bold">
                    ID: #FNB-<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?>
            ...
            <div class="space-y-2 mb-6 text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="font-bold"><?php echo e($order->created_at->format('d M Y, H:i')); ?></span>
                </div>
                <div class="flex justify-between">
            ...
            <div class="border-t-2 border-dashed border-gray-200 pt-6 mb-6 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between items-start">
                        <div class="flex-1">
                            <p class="font-bold text-sm leading-tight"><?php echo e($item->foodBeverage->name); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($item->quantity); ?> x Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></p>
                        </div>
                        <p class="font-bold text-sm">Rp <?php echo e(number_format($item->price * $item->quantity, 0, ',', '.')); ?></p>
                    </div>
            ...
            <div class="border-t-2 border-gray-100 pt-4 mb-8 flex justify-between items-center">
                ...
                <span class="text-2xl font-black italic">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></span>
            </div>

            <div class="flex flex-col items-center justify-center p-6 bg-gray-50 rounded-2xl border-2 border-gray-100">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=FNB-<?php echo e($order->id); ?>" class="w-32 h-32 mb-4 mix-blend-multiply">
    ...
    <div class="mt-8 flex flex-col sm:flex-row gap-4 w-full max-w-md">
        <a href="<?php echo e(route('food.download', $order->id)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/cart/receipt.blade.php ENDPATH**/ ?>