...
<?php $__env->startSection('title', 'Detail Promo - ' . $promo->title); ?>
...
<div class="bg-gray-900 min-h-screen pt-24 pb-12">
    <div class="container mx-auto px-4">
        ...
        <nav class="flex mb-8 text-gray-400 text-sm">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-yellow-500">Home</a>
            <span class="mx-2">/</span>
            <a href="<?php echo e(route('home')); ?>#promos" class="hover:text-yellow-500">Promo</a>
            <span class="mx-2">/</span>
            <span class="text-white"><?php echo e($promo->title); ?></span>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="rounded-3xl overflow-hidden border border-gray-800 shadow-2xl">
                    <img src="<?php echo e($promo->thumbnail_url); ?>" class="w-full h-auto object-cover" alt="<?php echo e($promo->title); ?>">
                </div>
                ...
                <div class="mt-8 bg-gray-800/50 p-8 rounded-3xl border border-gray-700">
                    ...
                    <div class="prose prose-invert max-w-none text-gray-300">
                        <p class="text-lg leading-relaxed"><?php echo e($promo->description); ?></p>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-700">
                        ...
                        <ol class="list-decimal list-inside text-gray-400 space-y-2">
                            ...
                            <li>Masukkan kode promo <span class="text-yellow-500 font-mono font-bold"><?php echo e($promo->promo_code); ?></span> pada kolom yang tersedia.</li>
            ...
            <div class="lg:col-span-1">
                <div class="bg-yellow-500 p-6 rounded-3xl sticky top-24">
                    ...
                    <div class="flex items-center justify-between bg-black/10 rounded-xl p-4 border border-black/10 mb-6">
                        <span class="text-2xl font-mono font-black text-black tracking-tighter"><?php echo e($promo->promo_code); ?></span>
                        <button onclick="copyToClipboard('<?php echo e($promo->promo_code); ?>')" class="bg-black text-white text-xs px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors">
                            Copy
                        </button>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center text-sm border-b border-black/10 pb-2">
                            ...
                            <span class="text-black font-bold"><?php echo e($promo->expired_at->format('d M Y')); ?></span>
                        </div>
                    </div>

                    <a href="<?php echo e(route('home')); ?>" class="block w-full text-center bg-black text-white font-black uppercase py-4 rounded-xl mt-8 hover:bg-gray-800 transition-transform active:scale-95">
                        Paket Sekarang
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/promo_detail.blade.php ENDPATH**/ ?>