    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const x = setInterval(function() {
                ...
                countdownDisplay.innerHTML = "Berakhir dlm " + h + ":" + m + ":" + s;
       ...
       document.getElementById('btn-cancel-booking').addEventListener('click', function() {
        Swal.fire({
            ...
            text: "Kursi yang Anda pilih akan dilepas dan Anda harus memilih ulang.",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d33', // Merah untuk batal
            cancelButtonColor: '#3085d6', // Biru untuk tetap lanjut
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const x = setInterval(function() {
                ...
                countdownDisplay.innerHTML = "Berakhir dlm " + (hours > 0 ? hours + ":" : "") + minutes + ":" + (seconds < 10 ? "0" + seconds : seconds);
