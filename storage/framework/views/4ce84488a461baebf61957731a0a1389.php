...
<?php $__env->startSection('title', 'Tiket Saya - Sansflix'); ?>
...
<div class="container mx-auto px-4 py-10 min-h-screen">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookings->isEmpty()): ?>
        <div class="text-center py-20 bg-gray-800 rounded-xl border border-gray-700 opacity-75">
            ...
            <a href="<?php echo e(route('home')); ?>" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full transition font-bold">
                Cari Film Sekarang
            </a>
        </div>
    <?php else: ?>
                    ...
                    <div class="h-40 w-full relative overflow-hidden">
                        ...
                        <div class="absolute bottom-4 left-4 right-4">
                            <h3 class="font-bold text-xl text-white shadow-black drop-shadow-lg truncate">
                                <?php echo e($booking->showtime->movie->title); ?>

                            </h3>
                            <p class="text-xs text-gray-300"><?php echo e($booking->showtime->movie->genre); ?></p>
                        </div>
                    </div>

                    <div class="p-5">
                        <div class="flex justify-between items-center text-sm mb-3 text-gray-400 font-medium">
                            <span><i class="far fa-calendar-alt mr-1"></i> <?php echo e($booking->showtime->starts_at->format('d M Y')); ?></span>
                            <span><i class="far fa-clock mr-1"></i> <?php echo e($booking->showtime->starts_at->format('H:i')); ?></span>
                        </div>

                        <div class="flex justify-between items-center mb-4">
                            <div>
                                <p class="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Studio</p>
                                <p class="font-bold text-white"><?php echo e($booking->showtime->auditorium->name); ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Total</p>
                                <p class="font-bold text-red-400">
                                    <?php echo e($booking->details->count()); ?> Kursi
                                </p>
                            </div>
                        </div>

                        <div class="border-t border-gray-700 pt-4 flex justify-between items-center">
                            <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter <?php echo e($booking->status == 'paid' ? 'bg-green-600/20 text-green-500' : 'bg-yellow-600/20 text-yellow-500'); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->status == 'paid'): ?>
                                <a href="<?php echo e(route('booking.ticket', $booking->id)); ?>" class="text-blue-400 hover:text-white text-sm font-bold transition hover:underline">
                                    Lihat Tiket &rarr;
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('booking.success', $booking->id)); ?>" class="text-yellow-500 hover:text-white text-sm font-bold transition hover:underline">
                                    Bayar Sekarang &rarr;
                                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/history.blade.php ENDPATH**/ ?>