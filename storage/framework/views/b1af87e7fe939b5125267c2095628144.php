        ...
        <div class="w-full md:w-2/3 p-8 relative bg-gray-50 text-gray-800">
            ...
            <?php elseif($order->status == 'paid'): ?>
                <div class="h-full flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <div class="w-full">
                        <a href="<?php echo e(route('history')); ?>" class="block w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-bold py-4 rounded-xl transition shadow-lg flex items-center justify-center gap-2">
                             Lihat Pesanan Saya
                        </a>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/cart/payment.blade.php ENDPATH**/ ?>