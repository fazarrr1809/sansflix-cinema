...
<?php $__env->startSection('title', 'Pilih Kursi - ' . $showtime->movie->title); ?>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-10 bg-gray-900 p-6 rounded-2xl border border-gray-800 shadow-xl">
            <div class="flex items-center gap-4 mb-4 md:mb-0">
                <a href="<?php echo e(route('movies.show', $showtime->movie_id)); ?>" class="p-3 bg-gray-800 rounded-xl hover:bg-red-600 transition text-white">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div>
                    <h1 class="text-2xl font-black tracking-tight"><?php echo e($showtime->movie->title); ?></h1>
                    <p class="text-gray-500 text-sm uppercase tracking-widest font-bold">
                        <?php echo e($showtime->auditorium->name); ?> <span class="mx-2">•</span> <?php echo e($showtime->starts_at->format('H:i')); ?> WIB
                    </p>
                </div>
            </div>
            <div class="flex gap-4">
                <div class="text-right hidden md:block">
                    ...
                    <p class="text-xl font-black text-white italic">Rp <?php echo e(number_format($showtime->ticket_price, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="flex-1 bg-gray-900 p-10 rounded-3xl border border-gray-800 shadow-2xl overflow-x-auto">
                ...
                <form id="bookingForm" action="<?php echo e(route('booking.store')); ?>" method="POST">
                    ...
                    <div class="flex flex-col gap-3 items-center min-w-[600px]">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $seats->groupBy('row_letter'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $rowSeats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex gap-3 items-center">
                                <div class="w-8 font-black text-gray-700 text-center"><?php echo e($row); ?></div>
                                
                                <div class="flex gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rowSeats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <label class="relative group">
                                            <input type="checkbox" 
                                                ...
                                                data-price="<?php echo e($showtime->ticket_price); ?>"
                                                data-number="<?php echo e($seat->row_letter); ?><?php echo e($seat->seat_number); ?>"
                                                class="seat-checkbox"
                                                <?php echo e($isBooked ? 'disabled' : ''); ?>

                                                onchange="updateTotal()">
                                                
                                            <div class="seat-label <?php echo e($isBooked ? 'seat-booked' : ''); ?>">
                                            ...
                                            <div class="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none">
                                                <?php echo e($row); ?><?php echo e($seat->seat_number); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->iteration == ceil($rowSeats->count() / 2)): ?>
                                            <div class="w-10"></div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-gray-900 p-8 rounded-3xl border border-gray-800 shadow-2xl sticky top-24">
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex justify-between items-start">
                            ...
                            <p class="font-bold text-right text-sm"><?php echo e($showtime->movie->title); ?></p>
                        </div>

                        <div class="flex justify-between items-center">
                            <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Studio</p>
                            <p class="font-bold text-sm"><?php echo e($showtime->auditorium->name); ?></p>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/booking_seat.blade.php ENDPATH**/ ?>