...
<?php $__env->startSection('title', 'Riwayat Snacks - Sansflix'); ?>
...
<div class="bg-gray-950 min-h-screen py-16 text-white">
    <div class="container mx-auto px-4 max-w-4xl">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <a href="<?php echo e(route('fnb.index')); ?>" class="bg-yellow-600/10 hover:bg-yellow-600 text-yellow-500 hover:text-black px-6 py-2 rounded-xl border border-yellow-600/30 transition-all font-bold text-sm">
                + Pesan Lagi
            </a>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orders->isEmpty()): ?>
            <div class="bg-gray-900 rounded-3xl p-16 text-center border border-gray-800 shadow-2xl">
                ...
                <a href="<?php echo e(route('fnb.index')); ?>" class="bg-yellow-600 hover:bg-yellow-700 text-black px-8 py-3 rounded-full font-black transition-all shadow-lg shadow-yellow-600/20">
                    PESAN SEKARANG
                </a>
            </div>
        <?php else: ?>
                    ...
                    <div class="bg-gray-900 rounded-3xl border border-gray-800 overflow-hidden shadow-2xl transition-all hover:border-yellow-600/30 group">
                        <div class="bg-gray-800/40 p-6 border-b border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-mono font-bold text-gray-200">#FNB-<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 border-gray-800 pt-4 sm:pt-0">
                                <div class="text-left sm:text-right">
                                    ...
                                    <p class="text-xs font-bold"><?php echo e($order->created_at->format('d F Y')); ?> <span class="text-gray-600">•</span> <?php echo e($order->created_at->format('H:i')); ?></p>
                                </div>
                                <span class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter <?php echo e($order->status == 'paid' ? 'bg-green-600/10 text-green-500 border border-green-600/20' : 'bg-yellow-600/10 text-yellow-500 border border-yellow-600/20'); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center group/item">
                                    <div class="flex items-center gap-6">
                                        <div class="relative">
                                            <img src="<?php echo e($item->foodBeverage->image_url); ?>" class="w-16 h-16 object-cover rounded-2xl shadow-lg border border-gray-800">
                                        ...
                                        <div>
                                            <p class="font-black text-lg text-gray-100 group-hover/item:text-yellow-500 transition"><?php echo e($item->foodBeverage->name); ?></p>
                                            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest">Unit Price: Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-lg font-black text-white italic">Rp <?php echo e(number_format($item->price * $item->quantity, 0, ',', '.')); ?></p>
                                    </div>
                                </div>
                       ...
                       <div class="bg-gray-800/20 p-6 border-t border-gray-800 flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-2xl font-black text-yellow-500 italic">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></p>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status == 'paid'): ?>
                                <a href="<?php echo e(route('food.receipt', $order->id)); ?>" class="bg-yellow-600 hover:bg-white hover:text-black text-black font-black px-6 py-2 rounded-xl text-xs transition-all uppercase tracking-tighter">
                                    Lihat Struk
                                </a>
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('home')); ?>" class="text-gray-600 hover:text-white transition text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\sansflix\sansflix\resources\views/cart/history.blade.php ENDPATH**/ ?>